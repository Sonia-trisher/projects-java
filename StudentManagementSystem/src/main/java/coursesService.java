...
public class coursesService implements menuService<courses>{
    ...
    public void read(int id) {
        ...
        try(Connection conn = DBConnection.getConnection();
            ...
            while(rs.next()) {
                System.out.println(rs.getString("id") + " " + rs.getString("course_name") + " " + rs.getString("course_description"));
            }
    ...
    public List<courses> readAll() {
        ...
        try(Connection conn = DBConnection.getConnection();
            ...
            ResultSet rs = PS.executeQuery(sql)){
            while (rs.next()) {
                courses.add(new courses(rs.getInt("id"), rs.getString("course_name"), rs.getString("course_description")));
            }
        }catch(SQLException e){
    ...
    public void update(courses item) {
        ...
        try(Connection conn = DBConnection.getConnection();
            ...
            PS.executeUpdate();
            System.out.println("Course updated successfully" + item.getId());
